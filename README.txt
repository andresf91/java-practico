...
a persistence unit "practicojavaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "practicojava/pom.xml":
...
artifacts ("practicojava-ejb.jar" and "practicojava-web.war") are already built. You can build
